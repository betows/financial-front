...
<template>
  <div>
    ...
    <Revenue style="margin: 16px 0 48px;" />
  </div>
</template>
...
import SaldoFuturo from "~/components/SaldoFuturo.vue";
import ListaRevenue from "~/components/ListaRevenue.vue";
...
<style>
/* Estilos CSS da página principal podem ser adicionados aqui */
</style>
